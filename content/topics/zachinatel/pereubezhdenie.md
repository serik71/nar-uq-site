...
Ни в одной форме корень не означает «идти» или «посещать». Хождение к дому и присутствие при нём передаются другими корнями: странствование — ط-و-ف, оживление-посещение — ع-م-ر, приход — أتى. Корень ح-ج-ج удерживает единственное значение — переубеждение доводом.
...
Отсчёт ведётся по новолуниям, и они прямо связаны с переубеждением:
Спрашивают тебя о новолуниях. Скажи: «Это назначения для забывчивых людей и переубеждения». (2:189)
Время института — протяжённый период по лунному счёту, а не фиксированная календарная дата.
...
5. Цикличность
Переубеждение повторяется циклически, год за годом, и служит единицей счёта лет. Это видно из найма на срок, исчисляемый переубеждениями:
...
Поистине, счет месяцев у Зачинателя — двенадцать месяцев, по предписанию Зачинателя дня творения небес и земли. Из них четыре заповедны. То – Долг установленный! (9:36)
...
7. Отсрочивание
Текст указывает на искажение счёта заповедных месяцев — отсрочивание:
Поистине, отсрочивание лишь прибавление в закрытости. Заблуждаются в этом те, которые закрылись, разрешая это год и запрещая это год, чтобы согласовать счет того, что запретил Зачинатель… (9:37)
Слово, обозначающее отсрочивание, образовано от корня ن-س-أ — откладывать, отодвигать срок вперёд (от него же — торговля с отсрочкой платежа). Его следует отличать от созвучного корня ن-س-ي — забывать. Механизм, описанный в отрывке, — не забвение месяца, а сдвиг: «разрешая год, запрещая год», чтобы согласовать счёт. Сохраняется число заповедных месяцев, но смещается их положение в году.
8. Реконструкция исходного счёта
Текст фиксирует факт смещения и его механизм (9:37), но не называет ни исходных, ни конечных позиций заповедных месяцев. Здесь следует подчеркнуть симметрию: и традиционный список (первый, седьмой, одиннадцатый, двенадцатый месяцы) также не назван в тексте — он есть продукт позднейшей фиксации, не прямое утверждение. Таким образом, конкретный счёт остаётся вне прямого текста для обеих сторон. Сопоставление с предыдущим опытом (Часть III) позволяет выдвинуть реконструкцию исходных позиций — первого, третьего, седьмого и девятого месяцев, из которых два могли быть смещены отсрочиванием вперёд. Это выдвигается как обоснованная гипотеза, согласованная с механизмом смещения и с внешним сопоставлением, а не как доказанный из текста факт; традиционный список имеет тот же эпистемический статус — он также не выведен из текста напрямую.
...
Слово «сторона» здесь — от корня ق-ب-ل. Смена направления связи привязывает служение к Заповедному месту простирания ниц.
...
Слово, передаваемое традицией как имя собственное «Кааба», образовано от корня ك-ع-ب — выступать кубом — и означает кубическое строение по форме, не имя сакрального объекта. Первый дом в Бекке (16) и Заповедное место в Мекке связаны сменой стороны: служение переориентировано на Заповедное место.
20. Разграничение места простирания ниц и дома
Текст различает два заповедных объекта по функции. Заповедное место простирания ниц (الْمَسْجِد الْحَرَام) — от корня س-ج-د, простирание ниц — есть место служения для доверяющих. К нему не допускаются приобщающие соучастников по причине нечистоты:
...
Слово, передаваемое как топоним «Муздалифа», в тексте отсутствует вовсе: корень ز-ل-ف означает только приближение, близость, и топонима не образует. Во всех прочих местах текста эти слова — нарицательные понятия узнавания и восприятия.
